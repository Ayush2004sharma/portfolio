...
export function ProjectCard({ title, description, image, tags, category, featured = false }: ProjectCardProps) {
  const [isHovered, setIsHovered] = useState(false)

  return (
    <div
      className={`group block cursor-pointer transition-all duration-500 hover:scale-[1.02] ${
